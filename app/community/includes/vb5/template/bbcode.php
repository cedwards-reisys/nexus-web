...
*
* @package 		vBulletin
* @version		$Revision: 85117 $
* @date 		$Date: 2015-07-22 12:49:17 -0700 (Wed, 22 Jul 2015) $
*
*/
		...
		if (is_array($attachments) AND !empty($attachments))
		{
			foreach($attachments AS $attachment)
			{
				...
				if (!isset($this->userImagePermissions[$currentUserid][$attachment['parentid']]['cangetimageattachment']))
				{
					...
					$this->userImagePermissions[$currentUserid][$attachment['parentid']]['cangetimageattachment'] = $canDownloadImages;
				}
				if (!isset($this->userImagePermissions[$currentUserid][$attachment['parentid']]['canseethumbnails']))
				{
					...
					$this->userImagePermissions[$currentUserid][$attachment['parentid']]['canseethumbnails'] = $canDownloadImages;
				}
			}
		}
	}
	...
	protected function attachReplaceCallback($matches)
	{
		...
		{	// attachment specified by [attach] tag belongs to this post
			...
			*/
			...
			$hasPermission = (
				$this->userImagePermissions[$currentUserid][$attachment['parentid']]['cangetimageattachment'] OR
				$this->userImagePermissions[$currentUserid][$attachment['parentid']]['canseethumbnails']
			);
