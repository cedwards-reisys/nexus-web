...
define('FILE_VERSION', '5.1.9'); // this should match installsteps.php
if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '519'); // see vB_Datastore::check_options()
...
* @date		$Date: 2015-08-24 12:41:42 -0700 (Mon, 24 Aug 2015) $
*/
