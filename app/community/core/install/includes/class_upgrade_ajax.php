...
class vB_Upgrade_Ajax extends vB_Upgrade_Abstract
{
	...
	*/
	...
	{
		parent::init($script);
		$this->custnumber = (strlen('cfee121141f1f5655d685ea5b531df53') == 32) ? 'cfee121141f1f5655d685ea5b531df53' : md5(strtoupper('cfee121141f1f5655d685ea5b531df53'));
