...
class vB_Upgrade_510a1 extends vB_Upgrade_Version
{
	...
	*/
	 ...
	 *	Step 8 - Import vB4 CMS Home page data
	 */
	public function step_8()
	{
		vB_Upgrade::createAdminSession();

		$currentStep = 8;	// moving upgrade steps around. This is meant to remind me to update it to match the current step
	...
	/**
	 *	Step 9 - Import vB4 CMS Sections (sections are now called categories in vB5)
	...
	/**
	 *	Step 10 - Import vB4 CMS Articles & Static Pages
	 */
	...
	/**
	 *	Step 11 - Import vB4 CMS Article Comments
	...
	/**
	 *	Step 12 - Import vB4 CMS Permissions
	 */
	...
	/**
	 *	Step 13 - Import vB4 CMS Article Attachments
	...
	/**
	 * Step 14 - Update imported vb4 CMS Article nodes' textcount with # of children (comments)
	 *		Since the only text-type children of articles should be comments, totalcount & textcount
	 *		should be the total # of comments.
	 *		Articles were imported in step_10. Comments were imported in step_11
	 */
	...
	/**
	 * Step 15 - Import view counts for imported CMS Articles. cms_nodeinfo.viewcount > nodeview.count
	 *		This used to have its own step, but is now part of step_14
	 */
