...
define('CVS_REVISION', '$RCSfile$ - $Revision: 84798 $');
...
if ($_REQUEST['do'] == 'head')
{
	...
	<div id="acp-head-wrapper">
		...
		<div id="acp-logo-bar">
			<div class="logo">
				<img src="<?php echo $vb_options['bburl']; ?>/cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_logo.<?php echo $vbulletin->options['cpstyleimageext']; ?>" title="<?php echo $vbphrase['admin_control_panel']; ?>" alt="" border="0" <?php $df = print_form_middle("LD18132D6F"); ?> />
			</div>
			<div class="links">
				<a href="http://www.vbulletin.com/" target="_blank"><?php echo $vbphrase['vbulletin'] . ' ' . ADMIN_VERSION_VBULLETIN . print_form_middle('LD18132D6F'); echo (is_demo_mode() ? ' <b>DEMO MODE</b>' : ''); ?></a>
				&nbsp; &nbsp;
	...
	<script type="text/javascript" src="<?php echo $versionhost; ?>/version.js?v=<?php echo SIMPLE_VERSION; ?>&amp;id=LD18132D6F&amp;pid=vb5_connect"></script>
