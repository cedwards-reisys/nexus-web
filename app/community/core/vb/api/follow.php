 ...
 * @version $Id: follow.php 84546 2015-04-09 21:27:58Z ksours $
 * @access public
 */
class vB_Api_Follow extends vB_Api
{
	...
	***/
	 ...
	 *	@param	mixed	$contenttypeclass Content types classes to filter the following. It can be a simple string or an array. The classes should contain 'vBForum_' prefix.
