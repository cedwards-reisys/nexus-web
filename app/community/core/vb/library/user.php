		...
		if ($users)
		{
			foreach ($users as $user)
			{
				...
				$maildata = vB_Api::instanceInternal('phrase')
					->fetchEmailPhrases('lostpw', array($user['username'], $vboptions['bbtitle'], $vboptions['frontendurl'], $vboptions['frontendurl'] . "/auth/lostpw/?action=pwreset&userid={$user['userid']}&activationid={$user['activationid']}"), array($vboptions['bbtitle']), $user['languageid']);
