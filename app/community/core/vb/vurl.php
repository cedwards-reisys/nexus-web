...
//force the internal follow location code instead of using the curl follow location
//primarly intended for testing where it is difficult to turn off/turn on open basedir
//This has not effect if VURL_FOLLOWLOCATION is not set
define('VURL_NOCURLFOLLOW',   262144);
...
*
* @package 		vBulletin
* @version		$Revision: 83961 $
* @date 		$Date: 2015-01-30 15:17:47 -0800 (Fri, 30 Jan 2015) $
*
*/
class vB_vURL
{
