...
class vB_dB_MYSQL_QueryDefs extends vB_dB_QueryDefs
{
	...
	* * */
	protected $table_data = array(
		...
		'widget' => array(
			'key' => 'widgetid',
			'structure' => array('widgetid', 'parentid', 'title', 'template', 'admintemplate', 'icon', 'isthirdparty', 'category', 'cloneable', 'guid', 'canbemultiple', 'product'),
		),
